...
//var_dump($sql); // tips cek isi variabel 
?>        
                  ...
                  <div class="card-body p-4">
                    ...
                    <div class="col-4">
                      <h4 class="fw-semibold mb-3">12</h4>
                        ...
                        $query1 = "select count(id) as jumlah_izin from izin where siswa_id = 3 and is_approved=2";
                        $sql = mysqli_query($is_connect, $query);
                        $sql1 = mysqli_query($is_connect, $query1);
                        $fetch_batas = mysqli_fetch_all($sql, MYSQLI_ASSOC);
                        $fetch_batas1 = mysqli_fetch_all($sql1, MYSQLI_ASSOC);
                        ?>
  
                        <div class="d-flex align-items-center mb-3"><?php echo $fetch_batas[0]['value']-$fetch_batas1[0]['jumlah_izin']?>
                        </div>
                      </div>
